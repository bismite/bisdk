...
# hidapi
run "cp build/macos/Frameworks/SDL2.framework/Versions/A/Frameworks/hidapi.framework/Versions/A/hidapi '#{Dir.pwd}/build/macos/lib/libhidapi.dylib'"
run "install_name_tool -id build/macos/lib/libhidapi.dylib '#{Dir.pwd}/build/macos/lib/libhidapi.dylib'"
run "install_name_tool -change '@rpath/hidapi.framework/Versions/A/hidapi' '#{Dir.pwd}/build/macos/lib/libhidapi.dylib' build/macos/lib/libSDL2.dylib"
